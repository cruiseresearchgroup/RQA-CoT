...
This repository contains the official implementation for analyzing Large Reasoning Models (LRMs) through the lens of dynamical systems. We propose **Recurrence Quantification Analysis (RQA)** as a non-textual framework to interpret Chain-of-Thought (CoT) processes by analyzing the latent trajectories of hidden states. Link to our [paper](https://arxiv.org/abs/2602.06266). 
